...
var GitHub = function (_Adapter) {
  ...
  function GitHub() {
    ...
    var _this = _possibleConstructorReturn(this, (GitHub.__proto__ || Object.getPrototypeOf(GitHub)).call(this, ['jquery.pjax.js']));
  ...
  _createClass(GitHub, [{
    key: 'init',
    value: function init($sidebar) {
      _get(GitHub.prototype.__proto__ || Object.getPrototypeOf(GitHub.prototype), 'init', this).call(this, $sidebar);
    ...
    value: function selectFile(path) {
      ...
      if ($pjaxContainer.length) {
        ...
        // falls back
        _get(GitHub.prototype.__proto__ || Object.getPrototypeOf(GitHub.prototype), 'selectFile', this).call(this, path);
      }
    }
...
var GitLab = function (_Adapter) {
  ...
  function GitLab(store) {
    ...
    var _this = _possibleConstructorReturn(this, (GitLab.__proto__ || Object.getPrototypeOf(GitLab)).call(this, ['turbolinks.js']));
  ...
  _createClass(GitLab, [{
    key: 'init',
    value: function init($sidebar) {
      _get(GitLab.prototype.__proto__ || Object.getPrototypeOf(GitLab.prototype), 'init', this).call(this, $sidebar);
...
$(document).ready(function () {
  ...
  // Markdown 格式的文档会被展示在 id 为 readme 的 div 中
  var readmeTitles = $("#readme").children("h2");
...
function inject() {
    var name = $("div.az h2 b a").text().toLowerCase();
    ...
    $("img").each(function (index, element) {
        ...
        var imgName = $element.parent().text().toLowerCase();
